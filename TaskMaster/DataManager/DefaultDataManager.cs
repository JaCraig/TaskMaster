...
namespace TaskMaster.DataManager
{
    ...
    /// </summary>
    /// <seealso cref="SimpleFileStore"/>
    public class DefaultDataManager : SimpleFileStore
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DefaultDataManager"/> class.
        /// </summary>
        /// <param name="serialBox">The serial box.</param>
        public DefaultDataManager(SerialBox.SerialBox serialBox)
            : base("./TaskMaster/", serialBox)
        {
        }
    }
}