...
namespace TaskMaster.Tests.Frequency
{
    public class RunHourlyTests
    {
        ...
        public void CanRun()
        {
            ...
            Assert.True(TestObject.CanRun(new LastRunInfo { LastRunStart = new DateTime(1999, 12, 31, 23, 59, 59) }, new DateTime(2000, 1, 1, 0, 0, 0)));
            Assert.False(TestObject.CanRun(new LastRunInfo { LastRunStart = new DateTime(2000, 1, 1, 0, 0, 0) }, new DateTime(2000, 1, 1, 0, 59, 0)));
            Assert.True(TestObject.CanRun(new LastRunInfo { LastRunStart = new DateTime(2000, 1, 1, 0, 0, 0) }, new DateTime(2000, 1, 1, 1, 0, 0)));
        }
    }
}