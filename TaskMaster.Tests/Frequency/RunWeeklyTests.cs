...
namespace TaskMaster.Tests.Frequency
{
    public class RunWeeklyTests
    {
        ...
        public void RunAfterNoon()
        {
            ...
            Assert.False(TestObject.CanRun(new DateTime(1900, 1, 1, 11, 0, 0), new DateTime(2016, 2, 15)));
            Assert.False(TestObject.CanRun(new DateTime(1900, 1, 1, 1, 0, 0), new DateTime(2016, 2, 14)));
            Assert.False(TestObject.CanRun(new DateTime(1900, 1, 1, 11, 59, 59), new DateTime(2016, 2, 15, 23, 59, 59)));
        }
    }
}